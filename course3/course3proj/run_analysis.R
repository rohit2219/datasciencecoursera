...
run_analysis<-function()
{
    ...
    print("started")
    setwd(dir = rohwork)
    #3) Uses descriptive activity names to name the activities in the data set. Doing this initally itslef
    ...
    #(temporarily writing to a file for personal review)
    write.csv(tidy_avg_mean_sd_df,file="aftertask5final.csv")
    # writing to a .txt file form submission
    write.table(tidy_avg_mean_sd_df,file="tidy_avg_mean_sd.txt",row.names = FALSE)
