...
print("Done with analysis and graphs")
...
print("visualisation of the correlation matrix")
chart.Correlation(df, histogram=TRUE, pch=19)


print(res.pca)

print("visualisation of the correlation matrix- done")
